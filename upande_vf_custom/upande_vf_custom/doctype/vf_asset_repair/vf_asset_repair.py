...
class VFAssetRepair(AccountsController):
    ...
    if TYPE_CHECKING:
        ...
        from upande_vf_custom.upande_vf_custom.doctype.vf_ar_purchase_invoices.vf_ar_purchase_invoices import (
            VFARPurchaseInvoices,
        )
        ...
        stock_items: DF.Table[VFAssetRepairConsumedItem]
        purchase_invoices: DF.Table[VFARPurchaseInvoices]
    ...
    def get_gl_entries_for_consumed_items(self, gl_entries, fixed_asset_account):
        ...
        stock_entry = frappe.get_doc("Stock Entry", {"vf_asset_repair": self.name})
